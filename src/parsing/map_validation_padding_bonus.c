...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   map_validation_padding_bonus.c                     :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
...
char	**build_padded_map_with_frame_bonus(char **raw_map, int rows,
	int width)
{
	char	**padded;
	int		t_rows;
...
int	is_map_enclosed_with_padding_bonus(char **padded_map, int rows,
	int cols)
{
	char	**visited;
	int		result;
